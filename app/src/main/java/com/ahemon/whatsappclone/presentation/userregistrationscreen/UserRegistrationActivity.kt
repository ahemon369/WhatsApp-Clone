package com.ahemon.whatsappclone.presentation.userregistrationscreen
...
fun UserRegistrationActivity() {
    ...
    Column(
        ...
        Row {
            Text(text = "WhatsApp will need to verify your phone number", color = Color.Gray)
